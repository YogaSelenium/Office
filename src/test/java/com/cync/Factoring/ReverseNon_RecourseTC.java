...
public class ReverseNon_RecourseTC extends BaseTest{
	...
	public void TC_01_ReverseFromFundedPage(String clientname,String shortname,String clientnumber,String successmsg,String BrokerName,String AccountName,String BankName,String AccountNo,String RoutingNo,String BrokerDays,String CommissionPercentage){
        ...
        //Step 1: navigate to Funded page
      ...
      //Step 3:Click on Reverse
        ...
        ExtentTestManager.getTest().log(LogStatus.PASS, "Successfully selected Reverse of a batch");
