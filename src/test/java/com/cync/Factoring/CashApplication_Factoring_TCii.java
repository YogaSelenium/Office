...
public class CashApplication_Factoring_TCii extends BaseTest{
	...
	@Test(dataProvider = "BatchProcess" , groups = { TestGroups.SMOKE,TestGroups.REGRESSION }, testName = "Verify the Batch Process screen")
	 ...
	 public void TC_01_Factored_Payment_BatchProcess(String clientname,String debtorname,String sourcetype,String checkrefno,String checkamount,String applyamount) throws InterruptedException
    {
...
//******************************************************************* FACTORED ***************    1
  ...
  //  String clientGname="304FACT";
   ...
   /* String checkrefno1="a";
    ...
    String applyAmtfetchedfromUI = batch.getValueFromFactoredCinvoiceAmtField(batch.CurrentAmtField_Factored_xpath);
   ...
   //step 38 : insert Batch No and Filter on Batch Process screen
	...
	@Test(dataProvider = "BatchProcess" , groups = { TestGroups.SMOKE,TestGroups.REGRESSION }, testName = "Verify the Batch Process screen")
	 ...
	 public void TC_02_Non_Factored_Payment_BatchProcess(String clientname,String debtorname,String sourcetype,String checkrefno,String checkamount,String applyamount) throws InterruptedException
   {
	...
	@Test(dataProvider = "BatchProcess" , groups = { TestGroups.SMOKE,TestGroups.REGRESSION }, testName = "Verify the Batch Process screen")
	 ...
	 public void TC_03_OnAccount_Payment_BatchProcess(String clientname,String debtorname,String sourcetype,String checkrefno,String checkamount,String applyamount) throws InterruptedException
   {     
	...
	@Test(dataProvider = "BatchProcess" , groups = { TestGroups.SMOKE,TestGroups.REGRESSION }, testName = "Verify the Batch Process screen")
	 ...
	 public void TC_04_Short_Payment_BatchProcess(String clientname,String debtorname,String sourcetype,String checkrefno,String checkamount,String applyamount) throws InterruptedException
  {     
	...
	@Test(dataProvider = "BatchProcess" , groups = { TestGroups.SMOKE,TestGroups.REGRESSION }, testName = "Verify the Batch Process screen")
	 ...
	 public void TC_05_Over_Payment_BatchProcess(String clientname,String debtorname,String sourcetype,String checkrefno,String checkamount,String applyamount) throws InterruptedException
  {     
	...
	@Test(dataProvider = "BatchProcess" , groups = { TestGroups.SMOKE,TestGroups.REGRESSION }, testName = "Verify the Batch Process screen")
	 ...
	 public void TC_06_Partial_Payment_BatchProcess(String clientname,String debtorname,String sourcetype,String checkrefno,String checkamount,String applyamount) throws InterruptedException
  {     
       ...
       System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>"+CurrentAmount_Calculated);
